        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{route('paper.edit',$paper->id)}}" class="btn btn-warning">Edit</a>
              <a href="{{route('questions.create',['paper_id'=>$paper->id])}}" target="_blank" class="btn btn-success">Add Question</a>
            </td>
          </tr>
          @endforeach
        </tbody>
